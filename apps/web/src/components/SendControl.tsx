...
export function SendControl({ mode, onMode, onSend, disabled, sendDisabled }: {
  ...
  return <Popover open={open} onOpenChange={setOpen}>
    <PopoverAnchor asChild>
      <Button ref={button} type="button" size="icon" className={cn("relative ml-auto size-11 shrink-0 touch-pan-y select-none [-webkit-touch-callout:none]", press.pressing && "scale-95")}
