...
test("drawer routes share the inbox stream and retain the new-task draft", async ({ page }) => {
  ...
  await expect(page.getByRole("dialog")).toHaveScreenshot("navigation-dark.png");
...
for (const width of [320, 390, 430]) {
  test(`drawer closes with Escape and scrim, restores focus, and opens Spaces at ${width}px`, async ({ page }) => {
